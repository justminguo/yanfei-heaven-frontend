...
def create_app() -> Flask:
    ...
    WEAPON_ENHANCE_DATA = {
        ...
        "火": [
            ...
            {"stage": 9, "chance": 100, "scroll_count": 80, "scroll_name": "火之武器強化卷軸", "effect_text": "吸血 100"},
        ],
        "風": [
            {"stage": 1, "chance": 100, "scroll_count": 10, "scroll_name": "風之武器強化卷軸", "effect_text": "爆傷加成 x0.8"},
            {"stage": 2, "chance": 70,  "scroll_count": 20, "scroll_name": "風之武器強化卷軸", "effect_text": "爆傷加成 x1.0"},
            {"stage": 3, "chance": 30,  "scroll_count": 30, "scroll_name": "風之武器強化卷軸", "effect_text": "爆傷加成 x1.2"},
            {"stage": 4, "chance": 20,  "scroll_count": 40, "scroll_name": "風之武器強化卷軸", "effect_text": "爆傷加成 x1.3"},
            {"stage": 5, "chance": 10,  "scroll_count": 55, "scroll_name": "風之武器強化卷軸", "effect_text": "爆傷加成 x1.4"},
            {"stage": 6, "chance": 5,   "scroll_count": 60, "scroll_name": "風之武器強化卷軸", "effect_text": "爆傷加成 x1.5"},
            {"stage": 7, "chance": 3,   "scroll_count": 65, "scroll_name": "風之武器強化卷軸", "effect_text": "爆傷加成 x1.6"},
            {"stage": 8, "chance": 4,   "scroll_count": 70, "scroll_name": "風之武器強化卷軸", "effect_text": "爆傷加成 x1.7"},
            {"stage": 9, "chance": 2,   "scroll_count": 80, "scroll_name": "風之武器強化卷軸", "effect_text": "爆傷加成 x1.8"},
        ],
    }
