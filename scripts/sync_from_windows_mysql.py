...
"""
    ...
    items = parse_tsv(run_remote_mysql(item_query, host=args.host, user=args.ssh_user, key_path=args.ssh_key, mysql_path=args.mysql_path, mysql_user=args.mysql_user, mysql_password=args.mysql_password))
    monsters = parse_tsv(run_remote_mysql(monster_query, host=args.host, user=args.ssh_user, key_path=args.ssh_key, mysql_path=args.mysql_path, mysql_user=args.mysql_user, mysql_password=args.mysql_password))
    drops = parse_tsv(run_remote_mysql(drop_query, host=args.host, user=args.ssh_user, key_path=args.ssh_key, mysql_path=args.mysql_path, mysql_user=args.mysql_user, mysql_password=args.mysql_password))
    weapons = parse_tsv(run_remote_mysql(weapon_query, host=args.host, user=args.ssh_user, key_path=args.ssh_key, mysql_path=args.mysql_path, mysql_user=args.mysql_user, mysql_password=args.mysql_password))
    armors = parse_tsv(run_remote_mysql(armor_query, host=args.host, user=args.ssh_user, key_path=args.ssh_key, mysql_path=args.mysql_path, mysql_user=args.mysql_user, mysql_password=args.mysql_password))
